...
namespace SdkManager.UI
{
    ...
    /// </summary>
    public class SdkToolItemViewModel : BaseViewModel
    {
        ...
        /// </summary>
        private ObservableCollection<SdkToolItemViewModel> _otherPackages;
        /// <summary>
        ...
        /// </summary>
        public ObservableCollection<SdkToolItemViewModel> OtherPackages
        {
            get => _otherPackages;
            set {
        ...
        public SdkToolItemViewModel(SdkItemBase package, bool canExpand)
        {
            _package = package;
            CanExpand = canExpand;
        ...
        private void GetOtherPackages()
        {
            if(!CanExpand)
            {
                _otherPackages = new ObservableCollection<SdkToolItemViewModel>();
            }
            else
            {
                ...
                {
                    _otherPackages = new ObservableCollection<SdkToolItemViewModel>(
                        children.Select(p => new SdkToolItemViewModel(p, false))
                        );
                }
            }
