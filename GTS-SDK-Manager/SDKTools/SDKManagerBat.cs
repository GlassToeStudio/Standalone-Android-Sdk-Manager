...
namespace GTS_SDK_Manager.SDKTools
{
    public static class SDKManagerBat
    {
        ...
        private static string pathName = @"C:\Users\GlassToe\AppData\Local\Android\Sdk";

        public async static Task<string[]> RunSDKManagerListVerbose(params string[] args)
        {
            if (AllData == null)
            {
        ...
        private static string _pathName = @"C:\Users\GlassToe\AppData\Local\Android\Sdk";
        ...
        //    if (AllData == null)
        //    {
        //        string YourApplicationPath = _pathName + @"\tools\bin\sdkmanager";
        //        string processOutput;
        ...
        //        var description = _body[i].Groups["Description"].ToString().Trim();
