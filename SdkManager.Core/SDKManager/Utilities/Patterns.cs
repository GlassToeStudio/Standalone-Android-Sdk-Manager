namespace SdkManager.Core   
{
    ...
    public static class Patterns
    {
        ...
        public const string CMAKE_PATTERN = @"(?<Platform>(?:cmake;)(?<APILevel>[.\d]*))(?:[\s]*Description[:][\s]*)(?<Description>CMake)(?:[\s\w.]*\n)(?:[\s]*[\w\s]*[:][\s]*)(?<Version>[.\d]*)(?:(?:[\s]*Installed Location[:][\s]*)(?<Installed_Location>[\s]*[\w\:\\\-.]*))?";
        ...
        public const string EMULATOR_PATTERN = @"(?<Platform>(?:emulator))(?:[\s\w]*[:][\s]*)(?<Description>Android[\s\w]*\n)(?:[\s]*[\w\s]*[:][\s]*)(?<Version>[\d]*.[\d]*.[\d]*)(?:(?:[\s]*Installed Location[:][\s]*)(?<Installed_Location>[\s]*[\w\:\\\-.]*))?"; // NO API LEVEL
        public const string PLATFORM_TOOLS_PATTERN =    @"(?<Platform>(?:platform-tools))(?:[\s]*Description[:][\s]*)(?<Description>Android[-\s\w]*\n)(?:[\s]*[\s]*Version[:][\s]*)(?<Version>[\d.]*)(?:(?:[\s]*Installed Location[:][\s]*)(?<Installed_Location>[\s]*[\w\:\\\-.]*))?"; // NO API LEVEL
        public const string SDK_TOOLS_PATTERN =         @"(?<Platform>^(?:tools))(?:[\s\w]*[:][\s]*)(?<Description>Android[-\s\w]*\n)(?:[\s]*[\w\s]*[:][\s]*)(?<Version>[\d.]*)(?:(?:[\s]*Installed Location[:][\s]*)(?<Installed_Location>[\s]*[\w\:\\\-.]*))?"; // NO API LEVEL
